...
server <- function(input, output, session) {
  ...
  # Module for handling user input and filtering data
  data_filtered <- module_input_server("inputs", dataset)
  # Module for county plot server logic, using the filtered data
  module_county_server("countyplot", df_filtered = data_filtered)
  # Module for yearly plot server logic, using the filtered data
  module_yearly_server("timeplot", df_filtered = data_filtered)
  
  # Module for handling user input and filtering data for state2
  data_filtered_2 <- module_input_server("inputs_2", dataset)
  # Module for county plot server logic for state2, using the filtered data
  module_county_server("countyplot_2", df_filtered = data_filtered_2)
  # Module for yearly plot server logic for state2, using the filtered data
